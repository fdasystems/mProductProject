...
namespace MVCWebAPIProducts.ConstantsWebApi
{
  public static class Constants
  {
    ...
    {
      public const string enableCorsUrls = "*"; // TEMP CONFIG THEN ENABLE ONLY NEED // "https://fdasystems.github.io,http://www.sisistemas.com.ar,http://localhost:4200"; //http://localhost:4200,
